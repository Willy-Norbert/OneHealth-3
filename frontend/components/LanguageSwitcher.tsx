    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button 
          ...
          className={`${className} ${variant === 'dashboard' ? 'h-9 px-3' : 'h-10 w-10'} mr-3 overflow-hidden rounded-full h-11 w-11 d-flex items-center justify-center`}
        >
          {variant === 'dashboard' ? (
            <>
              <Globe className="w-4 h-4 mr-2 d-flex items-center justify-center" />
