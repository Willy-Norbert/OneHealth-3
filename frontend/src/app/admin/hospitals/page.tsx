...
export default function AdminHospitalsPage() {
  ...
  async function apiFetch(path: string, init?: RequestInit) {
    ...
    const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL || 'https://onehealthconnekt.onrender.com'}${path}`, { ...init, headers: { 'Content-Type': 'application/json', Authorization: `Bearer ${token}` } })
    return res.json()
  }
