                      ...
                      <div className="flex flex-col space-y-2 ml-4">
                        ...
                        <button className="btn-outline btn-sm" onClick={async ()=>{
                          try {
                            ...
                            const res = await fetch(`${ ' https://api.onehealthline.com'}/medical-records?patient=${patient._id}`, { headers: { 'Content-Type':'application/json', Authorization: `Bearer ${token}` } })
