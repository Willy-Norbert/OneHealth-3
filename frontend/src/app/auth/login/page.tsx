      ...
      g.accounts.id.initialize({
        ...
        callback: async (response: any) => {
          ...
          try {
            ...
            const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL || 'https://onehealthconnect-nu4v.onrender.com'}/auth/google`, {
    ...
    async function handleFacebookLogin() {
      ...
      ;(window as any).FB.login(async (response: any) => {
          if (response.authResponse) {
            ...
            const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL || 'https://onehealthconnect-nu4v.onrender.com'}/auth/facebook`, {
