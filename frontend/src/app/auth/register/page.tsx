...
export default function RegisterPage() {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center p-4 sm:p-6 overflow-hidden bg-white dark:bg-gray-900 dark:text-gray-100">
      ...
      <div className="relative z-20 w-full max-w-5xl bg-white dark:bg-gray-800 rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div className="lg:hidden">
          ...
          <div className="bg-gradient-to-br from-emerald-500 to-green-600 p-6 text-center">
            ...
            <div className="bg-white/15 rounded-full p-4 mb-4 backdrop-blur-sm shadow-xl inline-block">
              <Image
          ...
          <div className="p-6">
            ...
            <div className="space-y-3 mb-6">
              <button className="w-full flex items-center justify-center space-x-3 py-3 px-4 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                ...
                <span className="text-gray-700 dark:text-gray-300 font-medium text-sm">Sign up with Google</span>
              </button>
              ...
              <button className="w-full flex items-center justify-center space-x-3 py-3 px-4 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                ...
                <span className="text-gray-700 dark:text-gray-300 font-medium text-sm">Sign up with Facebook</span>
              </button>
            </div>
