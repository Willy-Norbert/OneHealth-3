...
export default function GlobalError({ error, reset }: GlobalErrorProps) {
  ...
  return (
    <html>
      <body>
        <div className="min-h-screen relative overflow-hidden bg-gradient-to-b from-red-600 to-red-800">
          {/* Background Elements */}
          <div className="absolute inset-0">
            ...
            <div className="absolute bottom-0 left-0 w-full h-64">
              <div className="absolute bottom-0 left-0 w-full h-32 bg-red-900 transform -skew-y-1"></div>
              <div className="absolute bottom-0 left-0 w-full h-24 bg-red-800 transform -skew-y-2"></div>
              <div className="absolute bottom-0 left-0 w-full h-16 bg-red-700 transform -skew-y-1"></div>
            </div>
          </div>
              ...
              <div className="flex-1 text-center lg:text-left mb-8 lg:mb-0">
                <div className="relative">
                  <div className="w-32 h-32 lg:w-40 lg:h-40 mx-auto lg:mx-0 mb-6 relative">
                    <AlertTriangle className="w-full h-full text-white drop-shadow-2xl" />
                  ...
                  <div className="ml-6">
                    ...
                    <div className="mb-6 p-4 bg-white/10 rounded-lg border border-white/20">
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <span className="text-red-200 font-medium">Critical System Error</span>
                      </div>
                      {error.digest && (
                        <div className="flex items-center justify-between">
                          <span className="text-white">Error ID:</span>
                          <span className="text-white/70 font-mono text-xs">{error.digest}</span>
                        </div>
                      )}
                    </div>
                    ...
                    <div className="space-y-3 mb-6">
                      <button
                        onClick={handleReset}
                        className="flex items-center text-white hover:text-red-200 transition-colors duration-200 group"
                      >
                      ...
                      <button
                        ...
                        className="flex items-center text-white hover:text-red-200 transition-colors duration-200 group ml-4"
                      >
          ...
          <div className="absolute bottom-20 left-1/2 transform -translate-x-1/2 w-full max-w-2xl px-4">
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
              <h3 className="text-white font-semibold mb-3 text-center">Critical Error - Immediate Action Required:</h3>
              <ul className="space-y-2">
                ...
                <li className="flex items-center text-white/80 text-sm">
                  <div className="w-1.5 h-1.5 bg-white/60 rounded-full mr-3"></div>
                  Your data is safe and will be restored after restart
                </li>
              </ul>
            </div>
          </div>
