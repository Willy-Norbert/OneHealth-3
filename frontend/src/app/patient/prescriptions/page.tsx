                    ...
                    <div key={rx._id} className="p-6 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors">
                      <div className="flex items-start justify-between">
                        ...
                        <div className="ml-4 flex flex-col gap-2">
                          <a href={`${process.env.NEXT_PUBLIC_API_URL || 'https://onehealthconnect-nu4v.onrender.com'}/prescriptions/${rx._id}/pdf`} target="_blank" rel="noopener noreferrer" className="btn-outline btn-sm">Download PDF</a>
                        </div>
                      </div>
                    </div>
                  ))}
