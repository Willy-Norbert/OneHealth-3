...
export default function MeetingRoom() {
  ...
  const API_BASE = process.env.NEXT_PUBLIC_API_URL || 'https://onehealthconnect-nu4v.onrender.com'
  const WS_URL = process.env.NEXT_PUBLIC_WS_URL || process.env.NEXT_PUBLIC_API_URL || 'https://onehealthconnect-nu4v.onrender.com'
